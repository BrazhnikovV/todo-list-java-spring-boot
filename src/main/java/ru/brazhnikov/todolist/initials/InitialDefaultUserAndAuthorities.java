package ru.brazhnikov.todolist.initials;
...
/**
 * InitialDefaultUserAndAuthorities - класс ранней настройки привилегий и ролей в системе,
 ...
 */
@Component
public class InitialDefaultUserAndAuthorities implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public void onApplicationEvent( ContextRefreshedEvent event ) {
        ...
        if ( user == null ) {
            ...
            User newUser = this.createDefaultUserIfNotFound( adminRole );
            this.createAuthorityIfNotFound( newUser.getUsername(), adminRole.getName() );
        }
    }
